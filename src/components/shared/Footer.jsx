        ...
        <div className="grid grid-cols-1 gap-8 lg:gap-12 lg:grid-cols-3 border-b-[1px] border-white py-10">
          <div className="">
            ...
            <p className="mt-2 text-[14px]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tincidunt id sem vel quis in turpis sit eget pellentesque. 
              Nunc etiicies in rhoncus, rhoncus in arcu. Tincidunt neque fusce vitaenisi aliquet. que maeae tortoere necsem commodo ac.
            </p>
          </div>
            ...
            <div className="flex flex-col mx-auto">
              ...
              <div className="bg-white md:w-6/12 lg:w-full mt-3 flex justify-between p-1 md:p-2 rounded-sm">
                ...
                <div className="flex gap-1 md:gap-2 py-1 px-2 md:w-28 lg:w-36 items-center bg-[#0086B0] hover:bg-[#006d8e]">
                  <Link href="/" className="text-sm md:text-base  lg:text-[14px]">
                    Subscribe
                  </Link>
                  <Image src="/arr.svg" width={20} height={20} alt="arrow" />
                </div>
              </div>
            </div>
          </div>
